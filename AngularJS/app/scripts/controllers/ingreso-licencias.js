...
angular.module('angularjsApp')
  .controller('IngresoLicenciasCtrl', function ($scope, $uibModal, $filter, $anchorScroll, trabajador, constantes, $rootScope, Notification) {
    $anchorScroll();
    $scope.datos = [];
  ...
  .controller('FormLicenciasCtrl', function ($rootScope, Notification, $scope, $uibModalInstance, objeto, licencia, fecha) {
    ...
    $scope.guardar = function(licen, trabajador){
      ...
      if( $scope.licencia.sid ){
        response = licencia.datos().update({id:$scope.licencia.sid}, Licencia);
      }else{
